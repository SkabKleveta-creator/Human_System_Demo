...
/the-human-system-p0a/
  ...
  /builds/
    ...
    the_human_system_rpg_p18_2_locked.html
  /docs/
    PATCH_18_2_LOCK_NOTES.md
    PATCH_19_LOCK_NOTES.md
...
For GitHub Pages, `index.html` is the playable entry point.
...
Open `index.html` directly in a browser, or serve it through GitHub Pages.
